...
import Menu, { MenuPosition } from "@followBack/GenericElements/PopupMenu/Menu";
...
const Message = ({
  ...
  return (
    <Menu
      ...
      actionParamsProps={actionParamsProps}
      onPress={() => {
    ...
    >
      ...
      >
        <View style={[styles.contentContainer, messageStyle]}>
          {text && (
